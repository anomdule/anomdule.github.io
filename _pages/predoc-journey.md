...
Following my M.S. in Applied Economics at the University of Maryland, I worked as a Research Assistant at the Center for Global Sustainability for over three years. During this time, I had the opportunity to work closely with researchers including Jiehong Lou, Mengye Zhu, and Jenna Behrendt on projects spanning energy, transportation, and climate policy. These experiences strengthened my skills in data analysis, econometrics, geospatial analysis, literature review, scientific writing, and communicating research findings.

I also worked as a Research Analyst Consultant at the World Bank for one year, supporting economic research and policy analysis related to agriculture and development in Sub-Saharan Africa. This experience further developed my critical thinking, empirical research, and quantitative analysis skills while exposing me to policy-oriented research in an international setting.
...
This page documents my preparation for doctoral study, the lessons I learned throughout the application process, the doctoral programmes to which I applied, and why I ultimately chose Penn State University.
...
Research focused on agriculture in Sub-Saharan Africa.
...
- **Recommendation Letters:** ✉️
  ...
  - 🎓 One academic recommendation from instructors in the University of Maryland's Applied Economics program. *(Yes—instructors are adjunct faculty, not professors! 😄 Great recommendation letters come from people who genuinely know your work, not necessarily the fanciest title.)* 🌟

- **Secret Sauce:** No successful Ph.D. application is built alone. If my application had a secret sauce, it was the weekly mentorship I received from an economist working at Amazon (at the time, maybe now too). From my solo authored sample research paper and statement of purpose, CV review, and mock interview questions, he invested time in helping me build the strongest application possible. I owe a great deal of my application's success to his guidance, which taught me not only how to build a stronger application but also how to think more critically as a researcher.
