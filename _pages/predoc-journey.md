...
- **✉️ Recommendation Letters:**
  - 👨‍🔬👩‍🔬 Two research supervisors (a combination of supervisors from the **Center for Global Sustainability** and the **World Bank**, depending on whether the programme was in Economics or Public Policy).
  - 🎓 One academic recommendation from **instructors** in the University of Maryland's Applied Economics program. *(Yes—instructors, not professors! 😄 Great recommendation letters come from people who genuinely know your work, not necessarily the fanciest title.)* 🌟
...
- Research experience mattered far more than I initially expected.
- A strong research writing sample can open more doors than a slightly higher GRE score.
