...
<style>
/* ==========================================================
   HOME / INTRO PAGE — USE FULL AVAILABLE CONTENT WIDTH
   ========================================================== */

@media screen and (min-width: 1024px) {

  /* Use all space allocated to the right column */
  .page__inner-wrap {
    width: 100% !important;
  ...
  /* Remove width restrictions from containers inside the page */
  .page__content > div {
    width: 100% !important;
    max-width: none !important;
  ...
  /* Allow paragraphs to use the available width */
  .page__content p {
    max-width: none !important;
  }
